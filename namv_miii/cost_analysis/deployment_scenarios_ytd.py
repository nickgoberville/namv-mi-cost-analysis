...
def main():
    ...
    for ax_num, drive_train in enumerate(drive_trains):
        ...
        for index in vehicles.index:
            ...
            ax[vehicles.vehicle[index]][ax_num].plot(vehicle.time[0:-1], total_ytd1, label="Scenario 1")
            ax[vehicles.vehicle[index]][ax_num].plot(vehicle.time[0:-1], total_ytd2, label="Scenario 2")
            ax[vehicles.vehicle[index]][ax_num].plot(vehicle.time[0:-1], total_ytd3, label="Scenario 3")
