...
class model:
    def __init__(self, df, index, miles_per_year=0, riders_per_year=100, assumptions_json='params/assumptions.json', modes_json='params/modes.json', inflation=False, mode='normal'):
