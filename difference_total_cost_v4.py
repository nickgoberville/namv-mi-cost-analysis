...
def plotax1(fm, year, c1, scale=1000):
    plots.append(ax1.plot(t, f.iterative_total('BEV', 'S', False, year, fm=fm, scale=scale), color=c1, linewidth=lw))

def plotax2(fm, year, c1, scale=1000):
    plots.append(ax2.plot(t, f.iterative_total('BEV', 'S', False, year, fm=fm, scale=scale), color=c1, linewidth=lw))
...
ax1.set_yticklabels(np.arange(-700, 100, 100), fontsize=20)
ax2.set_yticklabels(np.arange(-700, 100, 100), fontsize=20)
